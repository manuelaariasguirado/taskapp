			...
			<div>
                ...
                <div>
					...
					<div class="flex items-start">
						<!-- NO ENTIENDO QUE HACE ESTO AQUI ABAJO-->
						<div class="flex items-start">
						...
						<div class="text-sm font-medium text-gray-500 dark:text-gray-300">
							Registered? <router-link :to="{name: 'login'}" href="#" class="text-blue-700 hover:underline dark:text-blue-500">Log In</router-link>
						</div>
		</form>
	</div>
</div>
