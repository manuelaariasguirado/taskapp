<template>
  <div class="font-sans w-full min-h-screen m-0 pb-12">
        ...
        <div class="flex items-center justify-between py-4">
          ...
          <div class="hidden sm:flex sm:items-center">
            ...
            <button @click="cerrarsesion"
              class="text-gray-800 text-sm font-semibold border px-4 py-2 rounded-lg hover:text-purple-600 hover:border-purple-600">Log
              Out</button>
          </div>
        ...
        <div class="block sm:hidden bg-white border-t-2 py-2">
          <div class="flex flex-col">
            ...
            <div class="flex justify-between items-center border-t-2 pt-2">
              <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Sign in 25</a>
              <a href="#"
